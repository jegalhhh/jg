  ...
  return (
    ...
    >
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        <div className="relative order-1 md:order-2 flex justify-center items-center h-full py-8 md:py-0">
          <motion.div
            initial={{ scale: 0.8, opacity: 0 }}
            animate={{ scale: 1, opacity: 1 }}
            transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1], delay: 0.2 }}
            className="absolute z-0 h-[200px] w-[200px] rounded-full bg-yellow-400/90 sm:h-[260px] sm:w-[260px] md:h-[340px] md:w-[340px] lg:h-[440px] lg:w-[440px] xl:h-[500px] xl:w-[500px]"
          ></motion.div>
          <motion.img
            src={imageSrc}
            alt={imageAlt}
            className="relative z-10 h-auto w-40 object-contain object-bottom sm:w-52 md:w-64 lg:w-80 xl:w-96"
        ...
        >
          <h1 className="font-extrabold text-foreground whitespace-nowrap text-[clamp(2rem,7vw,7rem)] leading-[1.05]">
            {overlayText.part1}
            <br />
            {overlayText.part2}
          </h1>
